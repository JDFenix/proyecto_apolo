                    ...
                    <div class="form-group  mt-3">
                        ...
                        <div class="form-group  mt-3">
                            ...
                            <input type="text" class="form-control custom-input-teacher-md  " name="license"
                                id="license" value="{{ $license }}" readonly>
                        </div>

                        <div class="form-group mt-3">
                            <label for="email">Materia que imparte</label>
                            <select class="form-select form-select-lg mb-3 custom-input-teacher"
                                name="subjects_taught" id="subjects_taught" aria-label="Large select example">

                                <option selected value="Programacion Orientada a Objetos">Programacion Orientada a
                                    Objetos</option>
