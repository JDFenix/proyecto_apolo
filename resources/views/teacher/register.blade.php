                ...
                <form action="{{ route('register') }}" method="post" enctype="multipart/form-data" class="mx-auto">
                    ...
                    <div class="form-group  mt-3">
                        ...
                        <input type="text" class="form-control custom-input-teacher" name="maternal_surname"
                            id="maternal_surname" value="
                            {{-- {{ $maternal_surname }} --}}" readonly>
                    </div>
                    <div class="form-group  mt-3">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select class="form-select form-select-lg mb-3 custom-input-teacher" name="professional_title"
                            id="professional_title" aria-label="Large select example">
                        ...
                        <div class="form-group  mt-3">
                            ...
                            <input type="text" class="form-control custom-input-teacher-md  " name="license"
                                id="license"
                                value="
                                {{-- {{ $license }} --}}
                                "
                        ...
                        <div class="form-group mt-3">
                            <label for="email">Materia que imparte</label>
                            <select class="form-select form-select-lg mb-3 custom-input-teacher" name="subjects_taught"
                            id="subjects_taught" aria-label="Large select example">
                               
                                <option selected value="Programacion Orientada a Objetos">Programacion Orientada a Objetos</option>
                                <option value="Algoritmos">Algoritmos</option>
                                <option value="Programacion Visual">Programacion Visual</option>
                            </select>
                        ...
                        <div class="form-group  mt-3">
                            ...
                            <div class="d-flex justify-content-center CustomTextColor mt-2 mb-4">
                                ...
                                <a href="{{ route('user.confirmRegister') }}"
